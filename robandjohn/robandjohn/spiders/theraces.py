...
class TheracesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        itemLoader.add_xpath('horse_number','//div[@class="tabs__content"]//div[@class="card-body"]//div[@class="card-entry "]//div[@class="card-cell card-cell--fill unpadded-left"]/div/div/div/h2/span[1]/text()', MapCompose(lambda  i: i.replace('.', '')))
